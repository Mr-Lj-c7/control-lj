#ifndef LOCALIZATION_STATUS_MSG_H
#define LOCALIZATION_STATUS_MSG_H
...
typedef struct MSF_SENSOR_MSG_STATUS {
...
typedef struct MSF_GNSS_MAP_OFFSET
{
    MsfGnssMapOffsetStatus status;
    double offsetx = 2;
    double offsety = 3;
} MsfGnssMapOffset;
...
typedef struct MSF_INIT_DETAILS
{
    MsfInitPoseSource init_pose_source;
    MsfInitPoseStatus local_search_from_integpva_status;
    MsfInitPoseStatus local_search_from_file_status;
    MsfInitPoseStatus local_update_from_file_status;
    MsfInitPoseStatus user_interaction_status;
    int32_t gnss_position_type;
    MsfInitPoseStatus local_from_global_lidar_status;
} MsfInitDetails;
...
typedef struct MSF_STATUS {
  ...
  uint32_t heading_position_type;
  MSFInitStatus msf_init_status;
  MsfRunningStatus msf_running_status;
  MsfInitDetails msf_init_details;
  LocalLidarQuality local_lidar_quality;
  MsfGnssMapOffset gnss_map_offset;
  bool lidar_alt_from_map;
  double local_lidar_score;
  bool local_reliability_status;
} MsfStatus;
